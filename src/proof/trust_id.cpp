...
const char* toString(TrustId id)
{
  switch (id)
  {
    ...
    case TrustId::PREPROCESS_REWRITE: return "PREPROCESS_REWRITE";
    case TrustId::PREPROCESS_FF_BITSUM: return "PREPROCESS_FF_BITSUM";
  case TrustId::PREPROCESS_FF_DISJUNCTIVE_BIT: return "PREPROCESS_FF_DISJUNCTIVE_BIT";
  case TrustId::PREPROCESS_FUN_DEF_FMF: return "PREPROCESS_FUN_DEF_FMF";
  case TrustId::PREPROCESS_LEARNED_REWRITE: return "PREPROCESS_LEARNED_REWRITE";
  case TrustId::PREPROCESS_LEARNED_REWRITE_LEMMA: return "PREPROCESS_LEARNED_REWRITE_LEMMA";
  case TrustId::PREPROCESS_BV_INTRO_POW2: return "PREPROCESS_BV_INTRO_POW2";
  case TrustId::PREPROCESS_FOREIGN_THEORY_REWRITE: return "PREPROCESS_FOREIGN_THEORY_REWRITE";
  case TrustId::PREPROCESS_UNCONSTRAINED_SIMP: return "PREPROCESS_UNCONSTRAINED_SIMP";
  case TrustId::PREPROCESS_STRINGS_EAGER_PP: return "PREPROCESS_STRINGS_EAGER_PP";
    // other
