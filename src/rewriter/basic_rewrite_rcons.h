...
class BasicRewriteRCons : protected EnvObj
{
 ...
 private:
  ...
  bool ensureProofMacroBoolNnfNorm(CDProof* cdp,
                                   const Node& lhs);
  bool ensureProofMacroArithStringPredEntail(CDProof* cdp,
                                             const Node& lhs);
  bool ensureProofMacroReInterUnionInclusion(CDProof* cdp,
                                             const Node& lhs);
};
