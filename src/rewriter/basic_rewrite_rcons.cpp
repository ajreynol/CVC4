    ...
    CDProof* cdp, Node a, Node b, theory::TheoryId tid, MethodId mid)
{
  ...
  ProofRewriteRule prid = d_env.getRewriter()->findRule(a, b, theory::TheoryRewriteCtx::PRE_DSL);
    ...
    CDProof* cdp, Node a, Node b, theory::TheoryId tid, MethodId mid)
{
  ...
  ProofRewriteRule prid = d_env.getRewriter()->findRule(a, b, theory::TheoryRewriteCtx::POST_DSL);
  if (prid != ProofRewriteRule::NONE)
  {
    if (tryRule(
            cdp, eq, ProofRule::THEORY_REWRITE, {mkRewriteRuleNode(prid), a}))
