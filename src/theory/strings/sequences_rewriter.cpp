      ...
      d_stringsEntail(r, d_arithEntail, *this)
{
  ...
  registerProofRewriteRule(ProofRewriteRule::STR_IN_RE_EVAL, TheoryRewriteCtx::DSL_SUBCALL);
  registerProofRewriteRule(ProofRewriteRule::RE_LOOP_ELIM, TheoryRewriteCtx::PRE_DSL);
  registerProofRewriteRule(ProofRewriteRule::RE_INTER_UNION_INCLUSION, TheoryRewriteCtx::PRE_DSL);
}
