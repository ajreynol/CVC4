...
class Word
{
 public:
   ...
   *   In other words, c is irrelevant for where d is contained when looking from the start
   *   of the string.
   *
   ...
   *   In other words, c is irrelevant for where d is contained when looking from the end
   *   of the string.
   *
