...
const char* toString(InferenceId i)
{
  switch (i)
  {
    ...
    case InferenceId::QUANTIFIERS_INST_EAGER: return "QUANTIFIERS_INST_EAGER";
    case InferenceId::QUANTIFIERS_INST_EAGER_CONFLICT: return "QUANTIFIERS_INST_EAGER_CONFLICT";
