...
class PatternTermSelector
{
 public:
   ...
   */
  Node getIsUsableTrigger(Node n, Node q);
 ...
 protected:
   ...
   */
  Node getIsUsableEq(Node q, Node eq);
  /** returns whether n1 == n2 is a usable (relational) trigger for q. */
  bool isUsableEqTerms(Node q, Node n1, Node n2);
