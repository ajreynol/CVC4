...
class Trigger : protected EnvObj
{
 ...
 public:
   ...
   * @param iid The inference id reported for instantiations generated by this
   * trigger, or UNKNOWN to use the backend's default inference id.
   */
  Trigger(Env& env,
          QuantifiersState& qs,
 ...
 protected:
  /** Get the inference id reported for an instantiation. */
  InferenceId getInstantiationInferenceId(InferenceId iid) const;
  ...
  Node d_quant;
  /** The inference id to use for instantiations, if set. */
  InferenceId d_instId;
  /** match generator
   *
