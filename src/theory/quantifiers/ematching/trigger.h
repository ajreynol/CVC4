...
class Trigger : protected EnvObj
{
 ...
 public:
  ...
  /**
   * Returns true if a newly added equivalence class term may affect the
   * instantiations generated by this trigger.
   */
  bool isRelevantTerm(TNode n) const;
  /**
   * Returns true if this trigger supports filtering based on relevant new
   * terms.
   */
  bool supportsRelevantTermFiltering() const;
 ...
 protected:
  ...
  Node d_trNode;
  /**
   * Whether relevant-term filtering is supported for this trigger.
   *
   * This is a conservative syntactic check used by the E-matching filter.
   */
  bool d_supportsRelevantTermFiltering;
  /**
   * The match operators whose new terms can create new candidates for this
   * trigger.
   */
  std::vector<Node> d_relevantMatchOps;
  /**
