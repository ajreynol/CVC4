                                    ...
                                    const std::set<Node>& termSet)
{
  ...
  for (const Node& n : termSet)
  {
    ...
    {
      // These elements may include internal witnesses for bag disequalities.
      // They are required for satisfying the constraints generated by this
      // solver, even when the element itself is not an input/relevant term.
