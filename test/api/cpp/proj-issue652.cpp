...
Term t4 = solver.mkTerm(SEQ_UNIT, {t1});
Sort s5 = t4.getSort();
Term t6 = solver.mkVar(s5, "_f13_0");
Term t7 = solver.mkTerm(SEQ_REPLACE_ALL, {t4, t4, t6});
Term t8 = solver.mkTerm(SEQ_AT, {t4, t1});
Term t9 = solver.mkTerm(SEQ_UPDATE, {t8, t1, t8});
Term t10 = solver.mkTerm(SEQ_EXTRACT, {t4, t1, t2});
Term t11 = solver.mkTerm(SEQ_REPLACE, {t10, t9, t7});
Sort s12 = solver.mkFunctionSort({s5}, s5);
Term t13 = solver.defineFun("_f13", {t6}, s5, t11, true);
Op o14 = solver.mkOp(APPLY_UF);
Term t15 = solver.mkTerm(o14, {t13, t4});
Term t16 = solver.mkTerm(APPLY_UF, {t13, t15});
Op o17 = solver.mkOp(SEQ_EXTRACT);
Term t18 = solver.mkTerm(o17, {t16, t3, t1});
Op o19 = solver.mkOp(SEQ_PREFIX);
