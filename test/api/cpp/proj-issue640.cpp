...
int main(void)
{
  ...
  Term t6 = solver.mkTerm(Kind::SET_INSERT, {t4, t3, t5});
  Op o7 = solver.mkOp(Kind::SET_CHOOSE);
  Term t8 = solver.mkTerm(o7, {t6});
  Op o9 = solver.mkOp(Kind::SET_INSERT);
  Term t10 = solver.mkTerm(o9, {t8, t6});
  Op o11 = solver.mkOp(Kind::SET_IS_SINGLETON);
  Term t12 = solver.mkTerm(o11, {t6});
  Term t13 = solver.mkTerm(Kind::ITE, {t12, t10, t5});
  Op o14 = solver.mkOp(Kind::SET_CHOOSE);
  Term t15 = solver.mkTerm(o7, {t13});
  Term t16 = solver.mkTerm(Kind::BAG_UNION_DISJOINT, {t3, t3});
  Op o17 = solver.mkOp(Kind::DISTINCT);
  Term t18 = solver.mkTerm(o17, {t16, t3});
  Term t19 = solver.mkTerm(Kind::BAG_DIFFERENCE_REMOVE, {t15, t3});
  Op o20 = solver.mkOp(Kind::BAG_SUBBAG);
  Term t21 = solver.mkTerm(o20, {t19, t3});
  Term t22 = t21.andTerm(t12);
  Op o23 = solver.mkOp(Kind::OR);
