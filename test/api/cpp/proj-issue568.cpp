...
Term t4 = solver.mkPi();
Sort s5 = t4.getSort();
Term t6 = solver.mkTerm(SET_SINGLETON, {t3});
Term t7 = solver.mkTerm(SET_MINUS, {t6, t2});
Term t8 = solver.mkTerm(TO_INTEGER, {t4});
Op o9 = solver.mkOp(SET_CHOOSE);
Term t10 = solver.mkTerm(o9, {t7});
Term t11 = solver.mkTerm(DISTINCT, {t8, t10});
Sort s12 = t11.getSort();
Op o13 = solver.mkOp(VARIABLE_LIST);
Term t14 = solver.mkTerm(o13, {t2});
Sort s15 = t14.getSort();
Op o16 = solver.mkOp(EXISTS);
